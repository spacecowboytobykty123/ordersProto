...
const file_orders_orders_proto_rawDesc = "" +
	"\n" +
	"\x13orders/orders.proto\x12\x06orders\"\xd5\x01\n" +
	"\x05Order\x12\x19\n" +
	...
	"\border_id\x18\x02 \x01(\x03R\aorderId\"F\n" +
	...
	"\rSTATUS_FAILED\x10\x052\x80\x03\n" +
	"\x06Orders\x12F\n" +
	"\vCreateOrder\x12\x1a.orders.CreateOrderRequest\x1a\x1b.orders.CreateOrderResponse\x12F\n" +
	"\vDeleteOrder\x12\x1a.orders.DeleteOrderRequest\x1a\x1b.orders.DeleteOrderResponse\x12=\n" +
	"\bGetOrder\x12\x17.orders.GetOrderRequest\x1a\x18.orders.GetOrderResponse\x12X\n" +
	"\x11ChangeOrderStatus\x12 .orders.ChangeOrderStatusRequest\x1a!.orders.ChangeOrderStatusResponse\x12M\n" +
	"\x10ListOrderHistory\x12\x1b.orders.OrderHistoryRequest\x1a\x1c.orders.OrderHistoryResponseB\rZ\vord.v1.ordsb\x06proto3"
